      ...
      <div className="container">
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className="relative w-3/4 lg:w-1/2 xl:w-[770px] z-10 order-2 lg:order-1">
            <img src={aboutImg} alt="about-section-img.png" />
            <div className="absolute z-20 bottom-4 w-[200px] md:w-[300px] right-[-30%] md:right-[-7%] lg:right-[-1%]">
              <img src={aboutCardImg} alt="about-section-card-img.png" />
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            ...
            <p className="text_para text-textColor  mt-[10px]">
            ...
            <p className="text_para text-textColor  mt-[20px]">
